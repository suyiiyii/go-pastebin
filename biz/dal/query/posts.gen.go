...
func newPost(db *gorm.DB, opts ...gen.DOOption) post {
	...
	_post.UserId = field.NewUint32(tableName, "user_id")
...
type IPostDo interface {
	...
	GetByUserId(userId uint32) (result []*model.Post, err error)
}

// GetByUserId get user by user id
//
// SELECT * FROM @@table WHERE user_id = @userId and deleted_at is null
func (p postDo) GetByUserId(userId uint32) (result []*model.Post, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, userId)
	generateSQL.WriteString("SELECT * FROM posts WHERE user_id = ? and deleted_at is null ")
